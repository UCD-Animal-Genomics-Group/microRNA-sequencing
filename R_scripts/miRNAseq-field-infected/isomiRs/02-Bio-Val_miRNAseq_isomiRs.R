...
##################################
# 17 Working directory and RData #
##################################
...
##########################################################
# 18 Tidy DGElist for exploratory data analysis plotting #
##########################################################
...
##########################################################
# 20 Plot: Gene expression correlation between libraries #
##########################################################
...
chart.Correlation(R = log(x = (dgelist_norm$counts[, grep(
  ...
  main = "IsomiRs Control group expression correlation")
dev.off()
...
chart.Correlation(R = log(x = (dgelist_norm$counts[, grep(
  ...
  perl = TRUE)] + 1), base = 2), histogram = TRUE, method = "spearman",
  main = "IsomiRs Infected group expression correlation")
dev.off()

##################################################
# 21 Define function for getting MDS coordinates #
##################################################
...
#####################################
# 23 Plot: MDS with all time points #
#####################################
...
#################################################
# 24 Create a design matrix for paired analysis #
#################################################
...
#########################################
# 25 Estimate the dispersion parameters #
#########################################
...
# File: 03-Bio-Val_miRNAseq_isomiRs.R
